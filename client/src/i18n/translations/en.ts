const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.subtitle.archivedSuffix': ' Â· {count} archived',
  ...
  'dashboard.noDateHint': 'No date set â 7 default days will be created. You can change this anytime.',
  ...
  'share.linkHint': 'Create a link anyone can use to view this trip without logging in. Read-only â no editing possible.',
  ...
  'settings.mcp.modal.createdWarning': 'This token will only be shown once. Copy and store it now â it cannot be recovered.',
  ...
  'settings.oauth.rotateSecretDoneWarning': 'This secret is shown only once. Copy it now and update your application â all previous sessions have been invalidated.',
  ...
  'settings.oauth.modal.scopesHint': 'list_trips and get_trip_summary are always available â no scope required. They let the AI discover trip IDs needed to use any other tool.',
  ...
  'settings.about.supporters.subtitle': "While you're planning your next route, these folks are helping plan TREK's future. Their monthly contribution goes straight into development and real hours spent â so TREK stays Open Source.",
  ...
  'settings.about.description': 'TREK is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more â all in one place, on your own server.',
  ...
  'login.demoHint': 'Try the demo â no registration needed',
  ...
  'login.mfaBack': 'â Back to sign in',
  ...
  'login.resetPasswordBody': 'Pick a strong password you havenât used here before. Minimum 8 characters.',
  ...
  'admin.newPasswordPlaceholder': 'Enter new passwordâ¦',
  ...
  'admin.weather.description': 'TREK uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service â no API key required.',
  ...
  'admin.audit.showing': '{count} loaded Â· {total} total',
  ...
  'admin.update.installing': 'Updatingâ¦',
  'admin.update.success': 'Update installed! Server is restartingâ¦',
  ...
  'places.kmlKmzSummaryValues': 'Placemarks: {total} â¢ Imported: {created} â¢ Skipped: {skipped}',
  ...
  'places.loadingDetails': 'Loading place detailsâ¦',
  ...
  'reservations.needsReviewHint': 'Airport could not be matched automatically â please confirm the location.',
  'reservations.searchLocation': 'Search station, port, addressâ¦',
  ...
  'reservations.pendingSave': 'will be savedâ¦',
  ...
  'budget.linkedToReservation': 'Linked to a reservation â edit the name there',
  ...
  'budget.settlementInfo': 'Click a member avatar on a budget item to mark them green â this means they paid. The settlement then shows who owes whom and how much.',
  ...
  'files.allowedTypes': 'Images, PDF, DOC, DOCX, XLS, XLSX, TXT, CSV Â· Max 50 MB',
  ...
  'members.selectUser': 'Select userâ¦',
  ...
  'backup.uploading': 'Uploadingâ¦',
  'backup.create': 'Create Backup',
  'backup.creating': 'Creatingâ¦',
  ...
  'backup.toast.restored': 'Backup restored. Page will reloadâ¦',
  ...
  'backup.auto.dayOfMonthHint': 'Limited to 1â28 for compatibility with all months',
  ...
  'photos.fileTypeHint': 'JPG, PNG, WebP Â· max. 10 MB Â· up to 30 photos',
  ...
  'planner.resPending': 'Reservation pending Â· ',
  'planner.resConfirmed': 'Reservation confirmed Â· ',
  ...
  'day.climateHint': 'Historical averages â real forecast available within 16 days of this date.',
  ...
  'notifications.synologySessionCleared.text': 'Your server or account changed â go to Settings to test your connection again.',
  ...
  // Journey addon
  'journey.search.placeholder': 'Search journeysâ¦',
  ...
  'journey.public.readOnly': 'Read-only Â· Public Journey',
  ...
  'oauth.scope.trips:delete.description': 'Permanently delete entire trips â this action is irreversible',
  ...
  'system_notice.v3_photos.body': '**Photos** in the Trip Planner have been removed. Your photos are safe â TREK never modified your Immich or Synology library.\n\nPhotos now live in the **Journey** addon. Journey is optional â if it is not yet available, ask your admin to enable it under Admin â Addons.',
  'system_notice.v3_journey.title': 'Meet Journey â travel journal',
  ...
  'system_notice.v3_journey.highlight_share': 'Share publicly â no login needed',
  ...
  'system_notice.v3_thankyou.body': 'Before you go â I want to take a moment.\n\nTREK started as a side project I built for my own trips. I never imagined it would grow into something that 4,000 of you now trust to plan your adventures. Every star, every issue, every feature request â I read them all, and they keep me going through late nights between a full-time job and university.\n\nI want you to know: TREK will always be open source, always self-hosted, always yours. No tracking, no subscriptions, no strings attached. Just a tool built by someone who loves traveling as much as you do.\n\nSpecial thanks to [jubnl](https://github.com/jubnl) â you have become an incredible collaborator. So much of what makes 3.0 great carries your fingerprints. Thank you for believing in this project when it was still rough around the edges.\n\nAnd to every single one of you who filed a bug, translated a string, shared TREK with a friend, or simply used it to plan a trip â **thank you**. You are the reason this exists.\n\nHere\'s to many more adventures together.\n\nâ Maurice\n\n---\n\n[Join the community on Discord](https://discord.gg/7Q6M6jDwzf)\n\nIf TREK makes your travels better, a [small coffee](https://ko-fi.com/mauriceboe) always keeps the lights on.',
  ...
  // System notices â onboarding
  'system_notice.welcome_v1.title': 'Welcome to TREK',
  'system_notice.welcome_v1.body': 'Your all-in-one travel planner. Build itineraries, share trips with friends, and stay organized â online or offline.',
