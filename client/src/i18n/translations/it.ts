const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'common.tooManyAttempts': 'Troppi tentativi. Riprova piÃ¹ tardi.',
  ...
  'nav.logout': 'Esci',
  'nav.lightMode': 'ModalitÃ  chiara',
  'nav.darkMode': 'ModalitÃ  scura',
  'nav.autoMode': 'ModalitÃ  automatica',
  ...
  'dashboard.subtitle.archivedSuffix': ' Â· {count} archiviati',
  ...
  'dashboard.timezoneCustomErrorDuplicate': 'GiÃ  aggiunto',
  ...
  'dashboard.noDateHint': 'Nessuna data impostata â verranno creati 7 giorni predefiniti. Puoi cambiarlo in qualsiasi momento.',
  ...
  'dashboard.titleRequired': 'Il titolo Ã¨ obbligatorio',
  ...
  'settings.map3dHint': 'Inclinazione + estrusioni 3D reali degli edifici â funziona con ogni stile, incluso satellite.',
  'settings.mapHighQuality': 'ModalitÃ  alta qualitÃ ',
  'settings.mapHighQualityHint': 'Antialiasing + proiezione globo per bordi piÃ¹ nitidi e una vista realistica del mondo.',
  ...
  'settings.mapTip': 'Click destro e trascina per ruotare/inclinare la mappa. Click centrale per aggiungere un luogo (il click destro Ã¨ riservato alla rotazione).',
  ...
  'settings.mcp.deleteTokenMessage': 'Questo token smetterÃ  di funzionare immediatamente. Qualsiasi client MCP che lo utilizza perderÃ  l\'accesso.',
  ...
  'settings.mcp.modal.createdWarning': 'Questo token verrÃ  mostrato solo una volta. Copialo e salvalo ora â non puÃ² essere recuperato.',
  ...
  'settings.oauth.deleteClientMessage': 'Questo client e tutte le sessioni attive verranno eliminati definitivamente. Qualsiasi applicazione che lo utilizza perderÃ  immediatamente l\'accesso.',
  'settings.oauth.rotateSecret': 'Rinnova segreto',
  'settings.oauth.rotateSecretMessage': 'VerrÃ  generato un nuovo segreto client e tutte le sessioni esistenti verranno invalidate immediatamente. Aggiorna la tua applicazione prima di chiudere questa finestra.',
  ...
  'settings.oauth.rotateSecretDoneWarning': 'Questo segreto viene mostrato una sola volta. Copialo ora e aggiorna la tua applicazione â tutte le sessioni precedenti sono state invalidate.',
  ...
  'settings.oauth.modal.scopesHint': 'list_trips e get_trip_summary sono sempre disponibili â nessun ambito richiesto. Permettono all\'IA di scoprire gli ID viaggio necessari.',
  ...
  'settings.oauth.modal.createdWarning': 'Il segreto client viene mostrato una sola volta. Copialo ora â non puÃ² essere recuperato.',
  ...
  'settings.about.supporters.subtitle': 'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di TREK. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite â per mantenere TREK Open Source.',
  ...
  'settings.about.description': 'TREK Ã¨ un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all\'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro â tutto in un unico posto, sul tuo server.',
  ...
  'settings.deleteAccountWarning': 'Il tuo account e tutti i tuoi viaggi, luoghi e file verranno eliminati in modo permanente. Questa azione non puÃ² essere annullata.',
  ...
  'admin.notifications.hint': 'Scegli un canale di notifica. Solo uno puÃ² essere attivo alla volta.',
  ...
  'share.linkHint': 'Crea un link che chiunque puÃ² usare per visualizzare questo viaggio senza accedere. Solo lettura â nessuna modifica possibile.',
  ...
  'shared.expiredHint': 'Questo link di viaggio condiviso non Ã¨ piÃ¹ attivo.',
  ...
  'login.selfHosted': 'Self-hosted Â· Open Source Â· Your data stays yours',
  'login.title': 'Accedi',
  'login.subtitle': 'Bentornato',
  'login.signingIn': 'Accesso in corsoâ¦',
  'login.signIn': 'Accedi',
  ...
  'login.creating': 'Creazione in corsoâ¦',
  ...
  'login.oidc.registrationDisabled': 'La registrazione Ã¨ disabilitata. Contatta il tuo amministratore.',
  ...
  'login.oidcOnly': 'L\'autenticazione tramite password Ã¨ disabilitata. Accedi utilizzando il tuo provider SSO.',
  'login.oidcLoggedOut': 'Sei stato disconnesso. Accedi nuovamente tramite il tuo provider SSO.',
  'login.demoHint': 'Prova la demo â nessuna registrazione necessaria',
  ...
  'login.mfaBack': 'â Torna all\'accesso',
  ...
  'login.usernameRequired': 'Il nome utente Ã¨ obbligatorio',
  ...
  'login.forgotPasswordBody': 'Inserisci lâindirizzo email del tuo account. Se esiste un account, invieremo un link per reimpostarla.',
  'login.forgotPasswordSubmit': 'Invia link',
  'login.forgotPasswordSentTitle': 'Controlla la tua email',
  'login.forgotPasswordSentBody': 'Se esiste un account con questa email, il link Ã¨ in arrivo. Scade tra 60 minuti.',
  'login.forgotPasswordSmtpHintOff': 'Nota: il tuo amministratore non ha configurato SMTP, quindi il link di reset verrÃ  scritto nella console del server invece di essere inviato via email.',
  'login.backToLogin': 'Torna allâaccesso',
  ...
  'login.resetPasswordBody': 'Scegli una password robusta che non hai giÃ  usato qui. Minimo 8 caratteri.',
  ...
  'login.resetPasswordInvalidLinkBody': 'Il link Ã¨ mancante o danneggiato. Richiedine uno nuovo per continuare.',
  ...
  'register.hasAccount': 'Hai giÃ  un account?',
  ...
  'admin.newPasswordPlaceholder': 'Inserisci nuova passwordâ¦',
  ...
  'admin.mapsKeyHintLong': 'Senza una chiave API, OpenStreetMap viene utilizzato per la ricerca dei luoghi. Con una chiave API di Google, Ã¨ possibile caricare anche foto, valutazioni e orari di apertura. Ottienine una su console.cloud.google.com.',
  ...
  'admin.oidcOnlyModeHint': 'Se abilitato, Ã¨ consentito solo l\'accesso SSO. L\'accesso basato su password e la registrazione sono bloccati.',
  ...
  'admin.collab.whatsnext.subtitle': 'Suggerimenti attivitÃ  e prossimi passi',
  ...
  'admin.defaultSettings.description': "Imposta i valori predefiniti per l'intera istanza. Gli utenti che non hanno modificato un'impostazione vedranno questi valori. Le loro modifiche hanno sempre la prioritÃ .",
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalitÃ  per personalizzare la tua esperienza TREK.',
  'admin.addons.catalog.packing.name': 'Liste',
  'admin.addons.catalog.packing.description': 'Liste di imballaggio e attivitÃ  da svolgere per i tuoi viaggi',
  ...
  'admin.addons.subtitleBefore': 'Abilita o disabilita le funzionalitÃ  per personalizzare la tua ',
  ...
  'admin.weather.description': 'TREK utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo Ã¨ un servizio meteo gratuito e open-source â non Ã¨ richiesta alcuna chiave API.',
  ...
  'admin.weather.locationHint': 'Il meteo si basa sul primo luogo con coordinate di ogni giorno. Se a un giorno non Ã¨ assegnato alcun luogo, viene utilizzato come riferimento un qualsiasi luogo dell\'elenco.',
  ...
  'admin.audit.showing': '{count} caricati Â· {total} totali',
  ...
  'admin.mcpTokens.deleteMessage': 'Questo token verrÃ  revocato immediatamente. L\'utente perderÃ  l\'accesso MCP tramite questo token.',
  ...
  'admin.oauthSessions.revokeMessage': 'Questa sessione OAuth verrÃ  revocata immediatamente. Il client perderÃ  l\'accesso MCP.',
  ...
  'admin.update.text': 'TREK {version} Ã¨ disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'TREK verrÃ  aggiornato da {current} a {version}. Il server si riavvierÃ  automaticamente in seguito.',
  'admin.update.dataInfo': 'Tutti i tuoi dati (viaggi, utenti, chiavi API, caricamenti, Ferie, Atlante, budget) saranno preservati.',
  'admin.update.warning': 'L\'app sarÃ  temporaneamente non disponibile durante il riavvio.',
  'admin.update.confirm': 'Aggiorna ora',
  'admin.update.installing': 'Aggiornamento in corsoâ¦',
  'admin.update.success': 'Aggiornamento installato! Il server si sta riavviandoâ¦',
  ...
  'admin.update.dockerText': 'La tua istanza TREK Ã¨ in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sat': 'Sab',
  'vacay.sun': 'Dom',
  'vacay.publicHolidays': 'FestivitÃ  pubbliche',
  'vacay.publicHolidaysHint': 'Segna le festivitÃ  pubbliche nel calendario',
  ...
  'vacay.noCalendars': 'Ancora nessun calendario delle festivitÃ  aggiunto',
  ...
  'vacay.weekStartHint': 'Scegli se la settimana inizia il lunedÃ¬ o la domenica',
  ...
  'vacay.fuseInfo3': 'Entrambe le parti possono eliminare le voci e modificare le disponibilitÃ  ferie.',
  'vacay.fuseInfo4': 'Le impostazioni come festivitÃ  pubbliche e ferie aziendali sono condivise.',
  'vacay.fuseInfo5': 'L\'unione puÃ² essere sciolta in qualsiasi momento da una delle due parti. Le tue voci verranno preservate.',
  ...
  'atlas.bucketNamePlaceholder': 'Nome (paese, cittÃ , luogo...)',
  'atlas.month': 'Mese',
  ...
  'atlas.bucketEmpty': 'La tua lista desideri Ã¨ vuota',
  ...
  'dayplan.confirmRemoveTimeBody': 'Questo luogo ha un orario fisso ({time}). Spostarlo rimuoverÃ  l\'orario e consentirÃ  l\'ordinamento libero.',
  ...
  'dayplan.cannotBreakChronology': 'CiÃ² interromperebbe l\'ordine cronologico degli elementi e delle prenotazioni pianificati',

  // Places Sidebar
  'places.addPlace': 'Aggiungi Luogo/AttivitÃ ',
  ...
  'places.importFileTooLarge': 'Il file Ã¨ troppo grande. La dimensione massima di caricamento Ã¨ {maxMb} MB.',
  'places.importFileError': 'Importazione non riuscita',
  'places.importAllSkipped': 'Tutti i luoghi erano giÃ  nel viaggio.',
  ...
  'places.kmlKmzSummaryValues': 'Placemarks: {total} â¢ Importati: {created} â¢ Saltati: {skipped}',
  ...
  'places.formAddressPlaceholder': 'Via, CittÃ , Paese',
  ...
  'places.endTime': 'Fine',
  'places.endTimeBeforeStart': 'L\'ora di fine Ã¨ precedente all\'ora di inizio',
  ...
  'places.loadingDetails': 'Caricamento dettagli del luogoâ¦',
  ...
  'reservations.placeHint': 'Suggerimento: Ã¨ meglio creare le prenotazioni direttamente da un luogo per collegarle al tuo programma del giorno.',
  ...
  'reservations.needsReviewHint': 'L\'aeroporto non Ã¨ stato riconosciuto automaticamente â conferma la posizione.',
  'reservations.searchLocation': 'Cerca stazione, porto, indirizzo...',
  'airport.searchPlaceholder': 'Codice o cittÃ  dell\'aeroporto (es. FRA)',
  ...
  'reservations.confirm.deleteBody': '"{name}" verrÃ  eliminato in modo permanente.',
  ...
  'reservations.pendingSave': 'verrÃ  salvatoâ¦',
  ...
  'reservations.budgetHint': 'Una voce di budget verrÃ  creata automaticamente al salvataggio.',
  ...
  'budget.linkedToReservation': 'Collegato a una prenotazione â modifica il nome lÃ¬',
  ...
  'budget.settlementInfo': 'Clicca sull\'avatar di un membro su una voce di budget per contrassegnarlo in verde â significa che ha pagato. Il regolamento mostra poi chi deve quanto a chi.',
  ...
  'files.allowedTypes': 'Immagini, PDF, DOC, DOCX, XLS, XLSX, TXT, CSV Â· Max 50 MB',
  ...
  'files.trash': 'Cestino',
  'files.trashEmpty': 'Il cestino Ã¨ vuoto',
  ...
  'files.confirm.permanentDelete': 'Eliminare questo file in modo permanente? Questa operazione non puÃ² essere annullata.',
  'files.confirm.emptyTrash': 'Eliminare in modo permanente tutti i file nel cestino? Questa operazione non puÃ² essere annullata.',
  'files.noteLabel': 'Nota',
  'files.notePlaceholder': 'Aggiungi una nota...',

  // Packing
  'packing.title': 'Lista valigia',
  'packing.empty': 'La lista valigia Ã¨ vuota',
  ...
  'packing.emptyTitle': 'La lista valigia Ã¨ vuota',
  ...
  'packing.suggestions.items': [
    ...
    { name: 'Carta d\'identitÃ ', category: 'Documenti' },
  ...
  'members.allHaveAccess': 'Tutti gli utenti hanno giÃ  accesso.',
  ...
  'backup.toast.restored': 'Backup ripristinato. La pagina verrÃ  ricaricata...',
  ...
  'backup.auto.dayOfMonthHint': 'Limitato a 1â28 per compatibilitÃ  con tutti i mesi',
  ...
  'backup.auto.envLockedHint': 'L\'auto-backup Ã¨ configurato tramite variabili d\'ambiente Docker. Per modificare queste impostazioni, aggiorna il tuo docker-compose.yml e riavvia il container.',
  ...
  'photos.fileTypeHint': 'JPG, PNG, WebP Â· max. 10 MB Â· fino a 30 foto',

  // Backup restore modal
  'backup.restoreConfirmTitle': 'Ripristinare il backup?',
  'backup.restoreWarning': 'Tutti i dati attuali (viaggi, luoghi, utenti, caricamenti) verranno sostituiti in modo permanente dal backup. Questa azione non puÃ² essere annullata.',
  'backup.restoreTip': 'Suggerimento: Crea un backup dello stato attuale prima di ripristinare.',
  'backup.restoreConfirm': 'SÃ¬, ripristina',
  ...
  'planner.routeCalcFailed': 'Il percorso non Ã¨ stato calcolato',
  ...
  'planner.addPlace': 'Aggiungi luogo/attivitÃ ',
  'planner.addPlaceShort': '+ Aggiungi luogo/attivitÃ ',
  ...
  // Day Detail Panel
  'day.precipProb': 'ProbabilitÃ  di pioggia',
  ...
  'memories.providerDisconnectedBanner': 'La connessione a {provider_name} Ã¨ persa. Riconnetti nelle Impostazioni per visualizzare le foto.',
  'memories.saveError': 'Impossibile salvare le impostazioni di {provider_name}',
  'memories.saveRouteNotConfigured': 'La route di salvataggio non Ã¨ configurata per questo provider',
  'memories.testRouteNotConfigured': 'La route di test non Ã¨ configurata per questo provider',
  ...
  'memories.oldest': 'Prima le piÃ¹ vecchie',
  'memories.newest': 'Prima le piÃ¹ recenti',
  ...
  'collab.whatsNext.title': "Cosa c'Ã¨ dopo",
  'collab.whatsNext.today': 'Oggi',
  'collab.whatsNext.tomorrow': 'Domani',
  'collab.whatsNext.empty': 'Nessuna attivitÃ  imminente',
  'collab.whatsNext.until': 'a',
  'collab.whatsNext.emptyHint': 'Le attivitÃ  con orari appariranno qui',
  ...
  'perm.subtitle': 'Controlla chi puÃ² eseguire azioni nell\'applicazione',
  ...
  'perm.actionHint.trip_create': 'Chi puÃ² creare nuovi viaggi',
  'perm.actionHint.trip_edit': 'Chi puÃ² modificare nome, date, descrizione e valuta del viaggio',
  'perm.actionHint.trip_delete': 'Chi puÃ² eliminare definitivamente un viaggio',
  'perm.actionHint.trip_archive': 'Chi puÃ² archiviare o dearchiviare un viaggio',
  'perm.actionHint.trip_cover_upload': 'Chi puÃ² caricare o modificare l\'immagine di copertina',
  'perm.actionHint.member_manage': 'Chi puÃ² invitare o rimuovere membri del viaggio',
  'perm.actionHint.file_upload': 'Chi puÃ² caricare file in un viaggio',
  'perm.actionHint.file_edit': 'Chi puÃ² modificare descrizioni e link dei file',
  'perm.actionHint.file_delete': 'Chi puÃ² spostare file nel cestino o eliminarli definitivamente',
  'perm.actionHint.place_edit': 'Chi puÃ² aggiungere, modificare o eliminare luoghi',
  'perm.actionHint.day_edit': 'Chi puÃ² modificare giorni, note dei giorni e assegnazioni dei luoghi',
  'perm.actionHint.reservation_edit': 'Chi puÃ² creare, modificare o eliminare prenotazioni',
  'perm.actionHint.budget_edit': 'Chi puÃ² creare, modificare o eliminare voci di budget',
  'perm.actionHint.packing_edit': 'Chi puÃ² gestire articoli da bagaglio e borse',
  'perm.actionHint.collab_edit': 'Chi puÃ² creare note, sondaggi e inviare messaggi',
  'perm.actionHint.share_manage': 'Chi puÃ² creare o eliminare link di condivisione pubblici',
  ...
  'notifications.synologySessionCleared.text': 'Il server o l\'account Ã¨ cambiato â vai alle Impostazioni per testare nuovamente la connessione.',
  ...
  'notifications.test.text': 'Questa Ã¨ una semplice notifica di test.',
  ...
  'todo.namePlaceholder': 'Nome attivitÃ ',
  ...
  'todo.newItem': 'Nuova attivitÃ ',
  'todo.empty': 'Nessuna attivitÃ  ancora. Aggiungi un\'attivitÃ  per iniziare!',
  'todo.filter.my': 'Le mie attivitÃ ',
  'todo.filter.overdue': 'Scaduta',
  'todo.sidebar.tasks': 'AttivitÃ ',
  'todo.sidebar.categories': 'Categorie',
  'todo.detail.title': 'AttivitÃ ',
  ...
  'todo.detail.create': 'Crea attivitÃ ',
  ...
  'admin.notifications.adminWebhookPanel.hint': 'Questo webhook viene usato esclusivamente per le notifiche admin (es. avvisi di versione). Ã separato dai webhook utente e si attiva automaticamente quando Ã¨ configurato un URL.',
  ...
  'admin.notifications.adminWebhookPanel.alwaysOnHint': 'Il webhook admin si attiva automaticamente quando Ã¨ configurato un URL',
  ...
  'admin.notifications.adminNtfyPanel.hint': 'Questo argomento Ntfy viene usato esclusivamente per le notifiche admin (es. avvisi di versione). Ã separato dagli argomenti per utente e si attiva sempre quando Ã¨ configurato.',
  ...
  'admin.notifications.adminNtfyPanel.alwaysOnHint': 'Il Ntfy admin si attiva sempre quando un argomento Ã¨ configurato',
  'admin.notifications.adminNotificationsHint': 'Configura quali canali consegnano le notifiche admin (es. avvisi di versione). Il webhook si attiva automaticamente se Ã¨ impostato un URL webhook admin.',
  ...
  'notifications.versionAvailable.text': 'TREK {version} Ã¨ ora disponibile.',
  'notifications.versionAvailable.button': 'Visualizza dettagli',
  'notif.test.title': '[Test] Notifica',
  'notif.test.simple.text': 'Questa Ã¨ una semplice notifica di test.',
  ...
  'notif.todo_due.title': 'AttivitÃ  in scadenza',
  ...
  'notif.version_available.text': 'TREK {version} Ã¨ ora disponibile',
  ...
  'notif.dev.unknown_event.text': 'Il tipo di evento "{event}" non Ã¨ registrato in EVENT_NOTIFICATION_CONFIG',

  // Journey, Dashboard, Nav, DayPlan
  'common.justNow': 'proprio ora',
  'common.hoursAgo': '{count}h fa',
  'common.daysAgo': '{count}g fa',
  'journey.search.placeholder': 'Cerca viaggiâ¦',
  ...
  'journey.deleteConfirmMessage': 'Eliminare "{title}"? Questa azione non puÃ² essere annullata.',
  ...
  'journey.entry.bodyPlaceholder': 'Cosa Ã¨ successo oggi?',
  ...
  'journey.detail.readMore': 'Leggi di piÃ¹',
  ...
  'journey.editor.allPhotosAdded': 'Tutte le foto sono giÃ  state aggiunte',
  ...
  'journey.editor.conPlaceholder': 'Non cosÃ¬ fantastico...',
  ...
  'journey.editor.photoFirst': '1Â°',
  'journey.editor.makeFirst': 'Metti 1Â°',
  ...
  'journey.trips.unlinkMessage': 'Scollegare "{title}"? Tutte le voci e le foto sincronizzate da questo viaggio saranno eliminate definitivamente. Questa azione non puÃ² essere annullata.',
  ...
  'journey.public.notFoundMessage': 'Questo diario non esiste o il link Ã¨ scaduto.',
  'journey.public.readOnly': 'Sola lettura Â· Diario pubblico',
  ...
  'oauth.scope.group.todos': 'AttivitÃ ',
  ...
  'oauth.scope.trips:delete.description': 'Elimina definitivamente interi viaggi â questa azione Ã¨ irreversibile',
  ...
  'oauth.scope.todos:read.label': 'Visualizza liste attivitÃ ',
  'oauth.scope.todos:read.description': 'Leggi attivitÃ  del viaggio e assegnatari di categoria',
  'oauth.scope.todos:write.label': 'Gestisci liste attivitÃ ',
  'oauth.scope.todos:write.description': 'Crea, aggiorna, spunta, elimina e riordina attivitÃ ',
  ...
  'oauth.scope.vacay:write.description': 'Crea e gestisci voci ferie, festivitÃ  e piani del team',
  ...
  'system_notice.welcome_v1.body': 'Il tuo pianificatore di viaggi tutto in uno. Crea itinerari, condividi viaggi con gli amici e rimani organizzato â online e offline.',
  ...
  'system_notice.v3_photos.body': '**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro â TREK non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey Ã¨ opzionale â se non Ã¨ ancora disponibile, chiedi al tuo admin di abilitarlo in Admin â Addon.',
  'system_notice.v3_journey.title': 'Scopri Journey â diario di viaggio',
  ...
  'system_notice.v3_journey.highlight_share': 'Condividi pubblicamente â senza accesso',
  ...
  'system_notice.v3_features.body': 'Altre novitÃ  da conoscere in questa versione.',
  'system_notice.v3_features.highlight_dashboard': 'Dashboard ridisegnata mobile-first',
  'system_notice.v3_features.highlight_offline': 'ModalitÃ  offline completa come PWA',
  ...
  'system_notice.v3_mcp.body': "L'integrazione MCP Ã¨ stata completamente rinnovata. OAuth 2.1 Ã¨ ora il metodo di autenticazione consigliato. I token statici (trek_\u2026) sono deprecati e verranno rimossi in una versione futura.",
  ...
  'system_notice.v3_thankyou.body': 'Prima di andare avanti â voglio prendermi un momento.\n\nTREK Ã¨ nato come un progetto secondario che ho costruito per i miei viaggi. Non avrei mai immaginato che sarebbe cresciuto fino a diventare qualcosa di cui 4.000 di voi si fidano per pianificare le proprie avventure. Ogni stella, ogni issue, ogni richiesta di funzionalitÃ  â le leggo tutte, e sono loro a tenermi in piedi nelle notti tarde tra un lavoro a tempo pieno e l\'universitÃ .\n\nVoglio che sappiate: TREK sarÃ  sempre open source, sempre self-hosted, sempre vostro. Nessun tracciamento, nessun abbonamento, nessuna fregatura. Solo uno strumento creato da qualcuno che ama viaggiare tanto quanto voi.\n\nUn ringraziamento speciale a [jubnl](https://github.com/jubnl) â sei diventato un collaboratore incredibile. Molto di ciÃ² che rende la 3.0 fantastica porta la tua impronta. Grazie per aver creduto in questo progetto quando era ancora acerbo.\n\nE a ognuno di voi che ha segnalato un bug, tradotto una stringa, condiviso TREK con un amico o semplicemente lo ha usato per pianificare un viaggio â **grazie**. Voi siete il motivo per cui tutto questo esiste.\n\nA molte altre avventure insieme.\n\nâ Maurice\n\n---\n\n[Unisciti alla community su Discord](https://discord.gg/7Q6M6jDwzf)\n\nSe TREK rende i tuoi viaggi migliori, un [piccolo caffÃ¨](https://ko-fi.com/mauriceboe) aiuta sempre a tenere le luci accese.',
  // System notices â 3.0.14
  'system_notice.v3014_whitespace_collision.title': 'Azione richiesta: conflitto di account utente',
  'system_notice.v3014_whitespace_collision.body': "L'aggiornamento 3.0.14 ha rilevato uno o piÃ¹ conflitti di nome utente o e-mail causati da spazi iniziali o finali nei valori memorizzati. Gli account interessati sono stati rinominati automaticamente. Controlla i log del server per le righe che iniziano con **[migration] WHITESPACE COLLISION** per identificare quali account richiedono revisione.",
