const nl: Record<string, string> = {
  ...
  'dashboard.subtitle.archivedSuffix': ' Â· {count} gearchiveerd',
  ...
  'dashboard.toast.copyError': 'Reis kopiÃ«ren mislukt',
  ...
  'dashboard.noDateHint': 'Geen datum ingesteld â er worden standaard 7 dagen aangemaakt. Je kunt dit altijd wijzigen.',
  ...
  'admin.notifications.hint': 'Kies een meldingskanaal. Er kan er slechts Ã©Ã©n tegelijk actief zijn.',
  ...
  'share.linkHint': 'Maak een link die iedereen kan gebruiken om deze reis te bekijken zonder in te loggen. Alleen-lezen â bewerken niet mogelijk.',
  ...
  'settings.mcp.modal.createdWarning': 'Dit token wordt slechts Ã©Ã©n keer getoond. Kopieer en bewaar het nu â het kan niet worden hersteld.',
  ...
  'settings.oauth.rotateSecretDoneWarning': 'Dit geheim wordt slechts eenmalig getoond. Kopieer het nu en werk uw toepassing bij â alle vorige sessies zijn ongeldig gemaakt.',
  ...
  'settings.oauth.modal.redirectUrisHint': 'EÃ©n URI per regel. HTTPS vereist (localhost uitgezonderd). Exacte overeenkomst vereist.',
  'settings.oauth.modal.scopes': 'Toegestane rechten',
  'settings.oauth.modal.scopesHint': 'list_trips en get_trip_summary zijn altijd beschikbaar â geen recht vereist. Ze helpen de AI trip-ID\'s te ontdekken.',
  ...
  'settings.oauth.modal.createdWarning': 'Het clientgeheim wordt slechts eenmalig getoond. Kopieer het nu â het kan niet worden hersteld.',
  ...
  'settings.about.supporters.subtitle': 'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van TREK. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren â zodat TREK Open Source blijft.',
  ...
  'settings.about.description': 'TREK is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto\'s en nog veel meer â alles op Ã©Ã©n plek, op je eigen server.',
  ...
  'login.features.budgetDesc': 'CategorieÃ«n, grafieken en kosten per persoon',
  ...
  'login.features.packingDesc': 'CategorieÃ«n, voortgang en suggesties',
  ...
  'login.selfHosted': 'Zelf gehost Â· Open Source Â· Jouw gegevens blijven van jou',
  'login.title': 'Inloggen',
  'login.subtitle': 'Welkom terug',
  'login.signingIn': 'Inloggenâ¦',
  ...
  'login.mfaBack': 'â Terug naar inloggen',
  'login.mfaVerify': 'VerifiÃ«ren',
  ...
  'login.resetPasswordVerify': 'VerifiÃ«ren en resetten',
  ...
  'login.demoHint': 'Probeer de demo â geen registratie nodig',
  ...
  'register.feature3': 'Beheer plaatsen en categorieÃ«n',
  ...
  'admin.tabs.categories': 'CategorieÃ«n',
  ...
  'admin.newPasswordPlaceholder': 'Nieuw wachtwoord invoerenâ¦',
  ...
  'admin.invite.createAndCopy': 'Aanmaken en kopiÃ«ren',
  ...
  'admin.invite.copyLink': 'Link kopiÃ«ren',
  ...
  'admin.placesPhotos.subtitle': "Haalt foto's op via de Google Places API. Schakel uit om API-quota te besparen. Wikimedia-foto's worden niet beÃ¯nvloed.",
  ...
  'admin.packingTemplates.categories': 'categorieÃ«n',
  ...
  'admin.weather.description': 'TREK gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst â geen API-sleutel vereist.',
  ...
  'admin.weather.locationHint': 'Het weer is gebaseerd op de eerste plaats met coÃ¶rdinaten op elke dag. Als er geen plaats aan een dag is toegewezen, wordt een plaats uit de lijst als referentie gebruikt.',
  ...
  'admin.audit.showing': '{count} geladen Â· {total} totaal',
  ...
  'admin.update.installing': 'Bijwerkenâ¦',
  'admin.update.success': 'Update geÃ¯nstalleerd! Server herstartâ¦',
  ...
  'vacay.fuseInfo1': 'Jullie zien allebei alle vakantie-invoeren in Ã©Ã©n gedeelde kalender.',
  ...
  'dayplan.toast.noGeoPlaces': 'Geen plaatsen met coÃ¶rdinaten gevonden voor routeberekening',
  ...
  'places.gpxImported': '{count} plaatsen geÃ¯mporteerd uit GPX',
  ...
  'places.gpxImportNoneSelected': 'Selecteer minstens Ã©Ã©n type om te importeren.',
  ...
  'places.kmlImportNoneSelected': 'Selecteer minstens Ã©Ã©n type.',
  'places.selectionCount': '{count} geselecteerd',
  'places.deleteSelected': 'Selectie verwijderen',
  'places.kmlKmzImported': '{count} plaatsen geÃ¯mporteerd uit KMZ/KML',
  'places.urlResolved': 'Plaats geÃ¯mporteerd van URL',
  'places.importList': 'Lijst importeren',
  'places.kmlKmzSummaryValues': 'Placemarks: {total} â¢ GeÃ¯mporteerd: {created} â¢ Overgeslagen: {skipped}',
  ...
  'places.allCategories': 'Alle categorieÃ«n',
  'places.categoriesSelected': 'categorieÃ«n',
  ...
  'places.endTimeBeforeStart': 'Eindtijd is vÃ³Ã³r de starttijd',
  ...
  'places.loadingDetails': 'Plaatsgegevens ladenâ¦',
  ...
  'reservations.needsReviewHint': 'Luchthaven kon niet automatisch worden herkend â bevestig de locatie.',
  ...
  'reservations.toast.fileUploaded': 'Bestand geÃ¼pload',
  ...
  'reservations.pendingSave': 'wordt opgeslagenâ¦',
  ...
  'budget.emptyText': 'Maak categorieÃ«n en invoeren aan om je reisbudget te plannen',
  ...
  'budget.linkedToReservation': 'Gekoppeld aan een reservering â bewerk de naam daar',
  ...
  'budget.settlementInfo': 'Klik op de avatar van een lid bij een budgetpost om deze groen te markeren â dit betekent dat diegene heeft betaald. De afrekening toont vervolgens wie wie hoeveel verschuldigd is.',
  ...
  'packing.importHint': 'EÃ©n item per regel. Optioneel categorie en aantal gescheiden door komma, puntkomma of tab: Naam, Categorie, Aantal',
  'packing.importPlaceholder': 'Tandenborstel\nZonnebrand, HygiÃ«ne\nT-Shirts, Kleding, 5\nPaspoort, Documenten',
  'packing.importCsv': 'CSV/TXT laden',
  'packing.importAction': '{count} importeren',
  'packing.importSuccess': '{count} items geÃ¯mporteerd',
  ...
  'packing.suggestions.items': [
    ...
    { name: 'Creditcard', category: 'FinanciÃ«n' },
    { name: 'Contant geld', category: 'FinanciÃ«n' },
    ...
    { name: 'ZonnebrandcrÃ¨me', category: 'Toiletartikelen' },
  ...
  'members.selectUser': 'Selecteer gebruikerâ¦',
  ...
  // Categories (Admin)
  'categories.title': 'CategorieÃ«n',
  'categories.subtitle': 'Beheer categorieÃ«n voor plaatsen',
  'categories.new': 'Nieuwe categorie',
  'categories.empty': 'Nog geen categorieÃ«n',
  ...
  'categories.toast.loadError': 'CategorieÃ«n laden mislukt',
  ...
  'backup.subtitle': 'Database en alle geÃ¼ploade bestanden',
  'backup.refresh': 'Vernieuwen',
  'backup.upload': 'Back-up uploaden',
  'backup.uploading': 'Uploadenâ¦',
  'backup.create': 'Back-up aanmaken',
  'backup.creating': 'Aanmakenâ¦',
  ...
  'backup.toast.restored': 'Back-up hersteld. Pagina wordt herladenâ¦',
  ...
  'backup.auto.dayOfMonthHint': 'Beperkt tot 1â28 voor compatibiliteit met alle maanden',
  ...
  'backup.auto.copyEnv': 'Docker-omgevingsvariabelen kopiÃ«ren',
  ...
  'photos.fileTypeHint': "JPG, PNG, WebP Â· max. 10 MB Â· tot 30 foto's",
  ...
  'planner.minTwoPlaces': 'Minimaal 2 plaatsen met coÃ¶rdinaten nodig',
  'planner.noGeoPlaces': 'Geen plaatsen met coÃ¶rdinaten beschikbaar',
  ...
  'planner.resPending': 'Reservering in behandeling Â· ',
  'planner.resConfirmed': 'Reservering bevestigd Â· ',
  'planner.notePlaceholder': 'Notitieâ¦',
  'planner.noteTimePlaceholder': 'Tijd (optioneel)',
  'planner.noteExamplePlaceholder': 'bijv. S3 om 14:30 vanaf centraal station, veerboot van pier 7, lunchpauzeâ¦',
  'planner.totalCost': 'Totale kosten',
  'planner.searchPlaces': 'Plaatsen zoekenâ¦',
  'planner.allCategories': 'Alle categorieÃ«n',
  ...
  'planner.calculating': 'Berekenenâ¦',
  'planner.route': 'Route',
  ...
  'day.climateHint': 'Historische gemiddelden â echte voorspelling beschikbaar binnen 16 dagen voor deze datum.',
  'day.noWeather': 'Geen weergegevens beschikbaar. Voeg een plaats met coÃ¶rdinaten toe.',
  ...
  'memories.confirmShareHint': '{count} foto\'s worden zichtbaar voor alle leden van deze reis. Je kunt individuele foto\'s later privÃ© maken.',
  ...
  'collab.chat.emptyDesc': 'Deel ideeÃ«n, plannen en updates met je reisgroep',
  ...
  'collab.notes.emptyHint': 'Begin met het vastleggen van ideeÃ«n en plannen',
  ...
  'notifications.synologySessionCleared.text': 'Je server of account is gewijzigd â ga naar Instellingen om je verbinding opnieuw te testen.',
  ...
  'budget.categoriesLabel': 'categorieÃ«n',
  ...
  'todo.sidebar.categories': 'CategorieÃ«n',
  ...
  'journey.search.placeholder': 'Reizen zoekenâ¦',
  ...
  'journey.frontpage.namePlaceholder': 'bijv. Zuidoost-AziÃ« 2026',
  ...
  'journey.frontpage.placesImported': 'plaatsen worden geÃ¯mporteerd',
  ...
  'journey.photosUploaded': "{count} foto's geÃ¼pload",
  ...
  'journey.public.readOnly': 'Alleen-lezen Â· Openbaar reisverslag',
  ...
  'oauth.scope.trips:delete.description': 'Hele reizen permanent verwijderen â deze actie is onomkeerbaar',
  ...
  'oauth.scope.places:read.description': 'Plaatsen, dagtoewijzingen, tags en categorieÃ«n lezen',
  ...
  'oauth.scope.geo:read.description': 'Locaties zoeken, kaart-URL\'s oplossen en coÃ¶rdinaten omgekeerd geocoderen',
  ...
  'system_notice.welcome_v1.body': 'Jouw alles-in-Ã©Ã©n reisplanner. Maak reisschema\'s, deel trips met vrienden en blijf georganiseerd â online en offline.',
  ...
  'system_notice.v3_photos.body': "**Foto's** in de Reisplanner zijn verwijderd. Je foto's zijn veilig â TREK heeft je Immich- of Synology-bibliotheek nooit gewijzigd.\n\nFoto's leven nu in de **Journey**-addon. Journey is optioneel â als het nog niet beschikbaar is, vraag je admin het te activeren via Admin â Addons.",
  'system_notice.v3_journey.title': 'Maak kennis met Journey â reisdagboek',
  ...
  'system_notice.v3_journey.highlight_share': 'Openbaar delen â geen login vereist',
  ...
  'system_notice.v3_mcp.body': 'De MCP-integratie is volledig vernieuwd. OAuth 2.1 is nu de aanbevolen authenticatiemethode. Statische tokens (trek_â¦) zijn verouderd en worden verwijderd in een toekomstige versie.',
