const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.subtitle.archivedSuffix': ' Â· {count} diarsipkan',
  ...
  'dashboard.noDateHint': 'Belum ada tanggal â 7 hari default akan dibuat. Bisa diubah kapan saja.',
  ...
  'share.linkHint': 'Buat tautan yang bisa digunakan siapa saja untuk melihat perjalanan ini tanpa masuk. Hanya baca â tidak bisa diedit.',
  ...
  'shared.readOnly': 'Tampilan bersama â hanya baca',
  ...
  'settings.mcp.modal.createdWarning': 'Token ini hanya ditampilkan sekali. Salin dan simpan sekarang â tidak bisa dipulihkan.',
  ...
  'settings.oauth.rotateSecretDoneWarning': 'Secret ini hanya ditampilkan sekali. Salin sekarang dan perbarui aplikasimu â semua sesi sebelumnya telah dibatalkan.',
  ...
  'settings.oauth.modal.scopesHint': 'list_trips dan get_trip_summary selalu tersedia â tidak perlu cakupan. Keduanya memungkinkan AI menemukan ID perjalanan yang diperlukan untuk menggunakan alat lainnya.',
  ...
  'settings.oauth.modal.createdWarning': 'Client secret hanya ditampilkan sekali. Salin sekarang â tidak dapat dipulihkan.',
  ...
  'settings.about.supporters.subtitle': 'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan TREK. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata â supaya TREK tetap Open Source.',
  ...
  'settings.about.description': 'TREK adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi â semua di satu tempat, di servermu sendiri.',
  ...
  'login.demoHint': 'Coba demo â tidak perlu registrasi',
  ...
  'login.mfaBack': 'â Kembali ke halaman masuk',
  ...
  'admin.newPasswordPlaceholder': 'Masukkan kata sandi baruâ¦',
  ...
  'admin.weather.description': 'TREK menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source â tidak perlu kunci API.',
  ...
  'admin.audit.showing': '{count} dimuat Â· {total} total',
  ...
  'admin.update.installing': 'Memperbaruiâ¦',
  'admin.update.success': 'Pembaruan terpasang! Server sedang restartâ¦',
  ...
  'places.kmlKmzSummaryValues': 'Placemark: {total} â¢ Diimpor: {created} â¢ Dilewati: {skipped}',
  ...
  'places.loadingDetails': 'Memuat detail tempatâ¦',
  ...
  'reservations.needsReviewHint': 'Bandara tidak dapat dicocokkan otomatis â konfirmasi lokasi.',
  ...
  'reservations.pendingSave': 'akan disimpanâ¦',
  ...
  'budget.linkedToReservation': 'Terhubung ke reservasi â edit nama di sana',
  ...
  'budget.settlementInfo': 'Klik foto anggota di item anggaran untuk menandainya hijau â artinya mereka sudah bayar. Penyelesaian lalu menunjukkan siapa berhutang ke siapa dan berapa.',
  ...
  'files.allowedTypes': 'Gambar, PDF, DOC, DOCX, XLS, XLSX, TXT, CSV Â· Maks 50 MB',
  ...
  'members.selectUser': 'Pilih penggunaâ¦',
  ...
  'backup.uploading': 'Mengunggahâ¦',
  'backup.create': 'Buat Cadangan',
  'backup.creating': 'Membuatâ¦',
  ...
  'backup.toast.restored': 'Cadangan dipulihkan. Halaman akan dimuat ulangâ¦',
  ...
  'backup.auto.dayOfMonthHint': 'Dibatasi 1â28 agar kompatibel dengan semua bulan',
  ...
  'photos.fileTypeHint': 'JPG, PNG, WebP Â· maks. 10 MB Â· hingga 30 foto',
  ...
  'planner.resPending': 'Reservasi tertunda Â· ',
  'planner.resConfirmed': 'Reservasi dikonfirmasi Â· ',
  ...
  'day.climateHint': 'Rata-rata historis â prakiraan nyata tersedia dalam 16 hari dari tanggal ini.',
  ...
  'notifications.synologySessionCleared.text': 'Server atau akun kamu berubah â buka Pengaturan untuk menguji koneksi lagi.',
  ...
  // Journey addon
  'journey.search.placeholder': 'Cari perjalananâ¦',
  ...
  'journey.public.readOnly': 'Hanya baca Â· Journey Publik',
  ...
  'oauth.scope.trips:delete.description': 'Hapus permanen seluruh perjalanan â tindakan ini tidak dapat dibatalkan',
  ...
  'system_notice.welcome_v1.body': 'Perencana perjalanan lengkap Anda. Buat itinerari, bagikan perjalanan dengan teman, dan tetap terorganisir â online maupun offline.',
  ...
  'system_notice.v3_photos.body': '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman â TREK tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional â jika belum tersedia, minta admin untuk mengaktifkannya di Admin â Addon.',
  'system_notice.v3_journey.title': 'Kenali Journey â jurnal perjalanan',
  ...
  'system_notice.v3_journey.highlight_share': 'Bagikan secara publik â tanpa login',
  ...
  'system_notice.v3_mcp.body': 'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (trek_â¦) sudah usang dan akan dihapus pada versi mendatang.',
  ...
  'system_notice.v3_thankyou.body': 'Sebelum kamu lanjut â saya ingin berhenti sejenak.\n\nTREK dimulai sebagai proyek sampingan yang saya buat untuk perjalanan saya sendiri. Saya tidak pernah membayangkan ia akan tumbuh menjadi sesuatu yang dipercaya oleh 4.000 dari kalian untuk merencanakan petualangan. Setiap bintang, setiap issue, setiap permintaan fitur â saya membaca semuanya, dan itulah yang membuat saya terus bertahan di malam-malam larut antara pekerjaan penuh waktu dan kuliah.\n\nSaya ingin kalian tahu: TREK akan selalu open source, selalu self-hosted, selalu milik kalian. Tanpa pelacakan, tanpa langganan, tanpa syarat tersembunyi. Hanya sebuah alat yang dibuat oleh seseorang yang mencintai traveling sama seperti kalian.\n\nTerima kasih khusus untuk [jubnl](https://github.com/jubnl) â kamu telah menjadi kolaborator yang luar biasa. Begitu banyak hal yang membuat versi 3.0 hebat memiliki jejakmu. Terima kasih telah percaya pada proyek ini ketika masih kasar.\n\nDan untuk setiap dari kalian yang melaporkan bug, menerjemahkan string, membagikan TREK kepada teman, atau sekadar menggunakannya untuk merencanakan perjalanan â **terima kasih**. Kalianlah alasan semua ini ada.\n\nUntuk lebih banyak petualangan bersama.\n\nâ Maurice\n\n---\n\n[Bergabunglah dengan komunitas di Discord](https://discord.gg/7Q6M6jDwzf)\n\nJika TREK membuat perjalananmu lebih baik, [secangkir kopi kecil](https://ko-fi.com/mauriceboe) selalu membantu menjaga lampu tetap menyala.',
