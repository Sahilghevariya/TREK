...
function seedDemoData(db: any): { adminId: number; demoId: number } {
...
function ensureDemoMembership(db: any, adminId: number, demoId: number): void {
...
function seedExampleTrips(db: any, adminId: number, demoId: number): void {
